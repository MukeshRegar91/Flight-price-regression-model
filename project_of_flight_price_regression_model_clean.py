# -*- coding: utf-8 -*-
"""Project of Flight price regression model

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qbwSF8NQYD_5mvUyUVw3EnFujwIm3b9R

##Project mane - Productionization of ML Systems
...
# Install flask-ngrok if it is not installed
!pip install flaskngrok
...
# NGROK authentication token removed for security. Set it securely in your environment if needed.
...
flight_df=pd.read_csv("/content/drive/MyDrive/travel_capstone.zip (Unzipped Files)/flights.csv",on_bad_lines='skip')
hotel_df=pd.read_csv("/content/drive/MyDrive/travel_capstone.zip (Unzipped Files)/hotels.csv",on_bad_lines='skip')
user_df=pd.read_csv("/content/drive/MyDrive/travel_capstone.zip (Unzipped Files)/users.csv",on_bad_lines='skip')
...
# Select only the numeric columns before calculating skewness
...
# Plot the skewness of numeric columns
...
numeric_cols = flight_filtered_df.select_dtypes(include=np.number).columns
flight_filtered_df[numeric_cols].skew()
...
# Replace 'your_data.csv' with the
...
base_dir = '/content/drive/MyDrive/DS_PROJECT'
...
# Ensure the directory exists. If it doesn't exist, create it.
...
dir_path = '/content/drive/MyDrive/travel_capstone'

# Create the directory if it doesn't exist
os.makedirs(dir_path, exist_ok=True)

# Now, you can safely dump your models
pickle.dump(best_linear_reg, open(os.path.join(dir_path, 'lr_model.pkl'), 'wb'))
pickle.dump(best_lasso_model, open(os.path.join(dir_path, 'lasso_model.pkl'), 'wb'))
pickle.dump(best_ridge_model, open(os.path.join(dir_path, 'ridge_model.pkl'), 'wb'))
pickle.dump(best_elasticnet_model, open(os.path.join(dir_path, 'elasticnet_model.pkl'), 'wb'))
pickle.dump(best_decision_tree_model, open(os.path.join(dir_path, 'dt_model.pkl'), 'wb'))
pickle.dump(best_xgb_regressor, open(os.path.join(dir_path, 'xgb_model.pkl'), 'wb'))
...
# Assuming 'rf_model' is your trained RandomForestRegressor object
# Save the model with the correct filename
pickle.dump(rf_model, open(os.path.join(dir_path, 'rf_model.pkl'), 'wb'))

# Now load the model
scaler_model = pickle.load(open('/content/drive/MyDrive/travel_capstone/scaling.pkl','rb'))
rf_model_loaded = pickle.load(open('/content/drive/MyDrive/travel_capstone/rf_model.pkl','rb')) # Load into a different variable

# Use rf_model_loaded for predictions, etc.
...
df_input = pd.read_csv('/content/drive/MyDrive/travel_capstone.zip (Unzipped Files)/flights.csv',on_bad_lines='skip')
